...
type ViewMode = 'overview' | 'prd' | 'srs' | 'vtp' | 'testing' | 'jobs' | 'arch' | 'sdd' | 'risk' | 'soup' | 'threat' | 'controls' | 'sec' | 'reference' | 'releases' | 'audit' | 'trace';
  ...
  return (
    <div className="container-fluid">
      ...
      {isDirectoryOpen && (
        <ViewTabs
          current={currentView}
          enabled={{ overview: true, prd: !!prdDoc, srs: !!srsDoc, vtp: !!vtpDoc, testing: !!vtpDoc, jobs: !launch.demo || !!jobsDoc, arch: !!(sad || dsl), sdd: !!sddDoc, risk: !!riskDoc, soup: !!soupDoc, threat: !!threatDoc, controls: !!srsDoc, sec: sec !== null, reference: !!referenceDoc, releases: !!releases, audit: !!srsDoc, trace: !!srsDoc }}

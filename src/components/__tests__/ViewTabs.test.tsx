...
describe('ViewTabs', () => {
  ...
  it('orders the tabs chronologically through the design-control phases', () => {
    ...
    expect(labels).toEqual(['Overview', 'PRD', 'SRS', 'SAD', 'SDD', 'VTP', 'Results', 'Auditor', 'Traceability', 'Releases', 'Jobs']);
  });
  ...
  it('labels each design-control phase with a band (Design Inputs spans the requirements tabs)', () => {
    ...
    // "Design Verification" spans VTP + Results — columns 6–7, since Design Outputs
    // now covers both the SAD and the SDD.

      ...
      {mode === 'edit' && canEdit ? (
        <div className="security-edit">
          ...
          <p className="text-muted" style={{ marginTop: 8 }}>
            Four views are expected: global system, multi-patient harm, updateability and patchability,
            and security use cases. Place diagrams with <code>![caption](name.svg)</code>.
          </p>
        </div>
      ) : (
